                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.update', $admin) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="department" class="col-md-4 col-form-label text-md-right">{{ __('Dib') }}</label>

                                <div class="col-md-6">
                                    <textarea id="dib" class="form-control @error('dib') is-invalid @enderror" name="department" >{{ old('department', $admin->department) }}</textarea>
